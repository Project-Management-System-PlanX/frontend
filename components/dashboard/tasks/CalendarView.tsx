											...
											.map((task) => (
												...
												>
													<div className="flex items-start justify-between gap-2">
														...
														{/* Assignee */}
														<div className="w-6 h-6 rounded-full border border-white/10 bg-emerald-500 flex items-center justify-center text-[10px] font-black text-white shrink-0 shadow-sm">
