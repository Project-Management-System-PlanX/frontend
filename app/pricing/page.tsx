...
const plans = [
  ...
  },
  {
    ...
    featLabel: 'Everything in Free, plus:',
  },
  {
    name: 'Premium',
    monthly: 12.5,
    ...
    featLabel: 'Everything in Standard, plus:',
  },
  {
    name: 'Enterprise',
    monthly: 210 / 12,
    ...
    featLabel: 'Everything in Premium, plus:',
  },
]

const comparisonRows = [
  { feature: 'Real-time conversation analysis', starter: true, pro: true, enterprise: true },
  { feature: 'Up to 10,000 messages/month', starter: true, pro: true, enterprise: true },
  { feature: 'Basic sentiment detection', starter: true, pro: true, enterprise: true },
  { feature: 'Email support', starter: true, pro: true, enterprise: true },
  { feature: 'Advanced emotional intelligence', starter: false, pro: true, enterprise: true },
  { feature: 'Up to 100,000 messages/month', starter: false, pro: true, enterprise: true },
  { feature: 'Multi-language support (50+ languages)', starter: false, pro: true, enterprise: true },
  { feature: 'Priority support', starter: false, pro: true, enterprise: true },
  { feature: 'Custom AI model training', starter: false, pro: false, enterprise: true },
  { feature: 'Unlimited messages', starter: false, pro: false, enterprise: true },
]
    ...
    <>
      ...
      <section className="pricing-hero">
        <div className="container">
          ...
          <p>Trusted by millions, TeamUp powers teams all around the world. Explore which option is right for you.</p>
              ...
              return (
                <div className={`plan-card${plan.featured ? ' featured' : ''}`} key={plan.name}>
                  ...
                  <div className="plan-price">
                    ...
                    <span className="amount">{price === 0 ? '0' : price % 1 === 0 ? price : price.toFixed(2)}</span>
                    <span className="period">USD</span>
                  </div>
                  <p className="plan-desc">{plan.desc}</p>
                  <button className="plan-btn">{plan.cta}</button>
                  <p className="plan-features-title">{plan.featLabel}</p>
